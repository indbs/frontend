...
export class GraphFR05 extends React.Component {
    ...
    requestData(){
        const self = this;
        const takeValue = this.props.commonValueFR05;
        var x = Number(takeValue.valuePass);
      
        const data_url = "http://172.16.20.75:8060/?graph=fr05&program_number="+x+"&year=2019";
                ...
                .then(function (response) {
                    ...
                    for (let i = 0; i < dataTable.length-1; i += 1) {
                        chartDataAll.push([
                            ...
                            dataTable[i].temperature,
                            dataTable[i].sp,
                            dataTable[i].output_power 
