  ...
  for (let i = 0; i < dataTimeLine.length; i += 1) {
    if ( i < dataTimeLine.length-1) {
      rowsTimeLine.push(
        ...
        timelineRaisaRowPauseLost(dataTimeLine[i], dataTimeLine[i + 1])  
      );
    }
  }
  return rowsTimeLine;
  ...
  for (let i = 0; i < dataTimeLine.length; i += 1) {
    if (i < dataTimeLine.length-1) {
      rowsTimeLine.push(
        ...
        timelineRaisa2RowPauseLost(dataTimeLine[i], dataTimeLine[i + 1])   
      );
    }
  }
  return rowsTimeLine;
  ...
  for (let i = 0; i < dataTimeLine.length; i += 1) {
    if (i < dataTimeLine.length-1) {
      rowsTimeLine.push(
        ...
        timelineFR05RowPauseLost(dataTimeLine[i], dataTimeLine[i + 1])
      );
    }
  }
  return rowsTimeLine;      
  ...
  for (let i = 0; i < dataTimeLine.length; i += 1) {
      if (i < dataTimeLine.length-1) {
        rowsTimeLine.push(
          ...
          timelineFR06RowPauseLost(dataTimeLine[i], dataTimeLine[i + 1])
        );
      }
    }
  return rowsTimeLine;
